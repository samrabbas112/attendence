...
<div class="container-md" style="margin:0 20% 0 20%;">
    <form method="post" action="<?php echo 'http://localhost/Attendence_System'; ?>/attendencee/update_employee" enctype="multipart/form-data">
        <div class="form-group">
            <label for="exampleInputEmail1">Name</label>
            <input type="text" class="form-control" name="name" id="name" value="<?php echo $data['data']->name; ?>"  placeholder="Enter Name">
            <div class="error">
        ...
        <div class="form-group">
            ...
            <input type="email" class="form-control" name="email" value="<?php echo $data->email; ?>" id="email" aria-describedby="emailHelp" placeholder="Enter email">
            <div class="error">
